...
<body class="gray-bg">
	...
	<!-- 新增和修改对话框 -->
	<div class="modal fade" id="modal_user_edit" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true" en>
					...
					<form id="form_user" method="post" action="reserveStu.htm" enctype="multipart/form-data">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<input type="checkbox" value="足球" name="hobbys">足球
								<input type="checkbox" value="拍球" name="hobbys">拍球
								<input type="checkbox" value="混球" name="hobbys">混球
